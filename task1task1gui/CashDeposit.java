...
public class CashDeposit {
	...
	public void cashDeposit() {
		...
		label1 = new JLabel("CASH DEPOSIT");
		...
		backToMenu.setBounds(120, 250, 150, 30);
			...
			public void actionPerformed(ActionEvent e) {
				...
				int temp=tempCurr;
				String tempStr="Amount Deposit : "+tempVar+"  Current Balance : "+tempCurr+"\n";
				ATMMain.insertCurrentBalance(temp, tempStr);
				ATMMain.insertTransaction(tempStr);
				textField.setText("");
